...
class InfiniteSlider<T : Number>(
    ...
    width: Int,
    height: Int,
    private val setting: InfiniteSetting<T>,
    ...
    private fun updateMessage() {
        val formattedValue =
            when (setting) {
                is InfiniteSetting.IntSetting -> setting.value.toString()
                is InfiniteSetting.FloatSetting -> String.format("%.2f", setting.value)
