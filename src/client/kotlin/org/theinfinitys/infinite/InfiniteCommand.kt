...
import org.theinfinitys.ConfigManager
import org.theinfinitys.ConfigurableFeature
import org.theinfinitys.InfiniteClient.error
import org.theinfinitys.InfiniteClient.info
import org.theinfinitys.InfiniteClient.log
import org.theinfinitys.InfiniteClient.searchFeature
import org.theinfinitys.InfiniteClient.warn
...
object InfiniteCommand {
    ...
    private fun setFeatureSetting(context: CommandContext<*>): Int {
        ...
        try {
            ...
            val mutableSetting = setting as InfiniteSetting<Any>
    ...
    private fun addRemoveFeatureSetting(
        ...
        if (setting is InfiniteSetting.StringListSetting || setting is InfiniteSetting.BlockListSetting) {
            @Suppress("UNCHECKED_CAST")
            val listSetting = setting as InfiniteSetting<MutableList<String>>
